...
const Blog = () => {
  ...
  const [activeTab, setActiveTab] = useState("recentBlog");
  ...
  const fetchBlogs = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Fetch profile information for each blog
      ...
      <div className="post-section">
        <div className="blog-grid">
          <div className="post-tab">
            <button
              onClick={() => handleTabClick("recentBlog")}
              className={`post-button ${
                activeTab === "recentBlog" ? "active" : ""
              }`}
            >
              <i className="fa-solid fa-fire-flame-curved"></i>Recent Blog
            </button>
            <button
          ...
          <div>
            ...
            {activeTab === "following" && (
              <div className="twee-map">
                {blogs
                  .filter(
                    (blog) => followStatus[blog.profile_id] === "Following"
                  )
                  .map((blog) => (
                    <div className="blog" key={blog._id}>
                      <div className="opos">
                      ...
                      <div className="button-group">
                        ...
                        <button
                          className={
                            likedBlogs.includes(blog._id) ? "liked" : ""
                          }
                          onClick={() => handleLike(blog._id)}
                        >
                          <i className="fas fa-heart"></i>
